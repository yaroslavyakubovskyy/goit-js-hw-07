...
const createGalleryCard = imageInfo => {
  return `
    <li>
      <img src="${imageInfo.url}" alt="${imageInfo.alt}" style="width: 200px; height: auto; border-radius: 8px;">
    </li>
  `;
};
...
refs.galleryList.style.flexWrap = 'wrap';
refs.galleryList.style.gap = '10px';
refs.galleryList.style.listStyle = 'none';
